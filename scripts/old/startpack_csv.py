...
# Rename only % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - %
        ...
        zielTarget, duration = einlesen(directory=quellTarget['pfad'], datum_uhrzeit=quellTarget['zeit'])

# Detect % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - %
        logging.info(f"Starting Detect: {datetime.now()}")
...
# Track % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - % - %
        logging.info(f"Starting Track: {datetime.now()}")
